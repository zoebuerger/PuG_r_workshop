...
head(nerd[["age"]])
head(nerd$ag)# here it would give you age even though there is a typo there without warning. the above version is less error likely!
```
...
nerd[1,] #in the brackets: rows, columns
```
...
```{r}
row_10_to_12 <- nerd [10:12, ] #don't forget the blank!
row_10_to_12
?nrow
```
